# Hash_Identifier.py
# Программное обеспечение для идентификации различных типов хэшей, используемых для шифрования данных и особенно паролей
...
def LineageIIC4(hash):
    ...
    if len(hash) == len(hs) and hash.isdigit() == False and hash.isalpha() == False and hash.isalnum() == True and hash[
                                                                                                                   0:2].find(
            '0x') == 0:
        jerar.append("107080")
