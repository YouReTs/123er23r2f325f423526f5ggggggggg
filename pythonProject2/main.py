...
class ProxyScraperChecker:
    ...
    async def fetch_source(
        ...
        """Get proxies from source. ### Получение прокси-серверов из источников.
        Args:
    ...
    async def check_proxy(
        ...
        """Check if proxy is alive. ### Проверка, работает ли прокси-сервер"""
        try:
            async with self.sem:
    ...
    async def fetch_all_sources(self) -> None:
        ...
        # Remember total count so we could print it in the table ### Запомнить общее количество, для расчета в таблице
    ...
    def save_proxies(self) -> None:
        """Delete old proxies and save new ones. ### Удаление старых прокси и сохранение новых."""
    ...
    async def main(self) -> None:
        ...
        self.save_proxies()
        self.c.print(
            "[green]Proxy folders have been created in the ### Прокси-папки были созданы в"
